      ...
      <div className=" container my-5 mx-auto grid grid-cols-1 md:grid-cols-2 h-screen">
        <div className="max-h-96 md:h-screen">
          <div className="md:my-16">
            <svg
              ...
              width="100%"
              height="100%"
              className=" p-12  object-cover object-top bg-light-blue-600 opacity-75"
        ...
        <div className="flex bg-gray-100 p-5 md:p-12">
          <div className="mb-auto mt-auto max-w-lg">
            <h1 className="text-3xl uppercase my-3">
              Welcome To The EyeCare Hospital
            </h1>
            <p>
              EyeCare Hospital is a leading private hospital at Khilgaon, Dhaka,
              Bangladesh. We started our journey in 2021. Almost all the
              services are available day and night. Professors & doctors are
              consulting with patients for 24 hours with all facilities of
              diagnostic and emergency services. We do care of patients at
              diabetic center, eye center, physiotherapy and dental care at very
              affordable cost. EyeCare Hospital offers all type of medical &
              healthcare services with up-to-date facilities which are
              completely managed by well-reputed medical specialists, expert
              nurses and technologist. Our main focus is to deliver modern
              Healthcare Services of Universal Standard through continuous
              innovation and development of quality services.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="rounded h-60  bg-indigo-500 p-4 transform translate-x-6 -translate-y-6  ">
                ...
                <div className="flex-grow ">
                  ...
                  <p className="leading-relaxed text-white  text-sm text-justify">
                    To provide quality health care services to the community
            ...
            <div className="pattern-dots-md gray-light">
              <div className="rounded h-60  bg-indigo-500 p-4 transform translate-x-6 -translate-y-6 ">
                ...
                <div className="flex-grow">
                  ...
                  <p className="leading-relaxed text-white  text-sm text-justify">
                    To be recognized as an Unic Hospital maintaining all sorts
                    of religious and professional ethics to be valued by our
                    patients.
                  </p>
                </div>
              </div>
            ...
            <div className="pattern-dots-md gray-light">
              <div className="rounded h-60 bg-indigo-500 p-4 transform translate-x-6 -translate-y-6 ">
                ...
                <div className="flex-grow">
                  ...
                  <p className="leading-relaxed text-white  text-sm text-justify">
                    To put our mission objectives into practice and contribute
                    towards future growth and development; we believe –every
                    brick has to add up and is equally important to build a
                    building.
                  </p>
                </div>
              </div>
